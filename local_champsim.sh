...
./bin/champsim-l2c-ampm --warmup-instructions 1000000 --simulation-instructions 10000000 ../traces/tomcat.gz >cp-data/tomcat.txt
./bin/champsim-l2c-ampm --warmup-instructions 1000000 --simulation-instructions 10000000 --wrong-path ../traces/tomcat.gz >wp-data/tomcat.txt
