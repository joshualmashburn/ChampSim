...
./bin/champsim-l1i-ip_stride --warmup-instructions 10000000 --simulation-instructions 100000000 ../new-traces/tomcat.gz >cp-data/tomcat.txt
./bin/champsim-l1d-ip_stride --warmup-instructions 1000000 --simulation-instructions 10000000 --wrong-path ../new-traces/tomcat.gz >wp-data/tomcat.txt
