...
enum DSPatch_pref_candidate { NONE = 0, COVP, ACCP, Num_DSPatch_pref_candidates };
...
public:
  ...
  DSPatch_PBEntry() : page(0xdeadbeef), trigger_pc(0xdeadbeef), trigger_offset(0) { bmp_real.reset(); }
  ~DSPatch_PBEntry() {}
};
